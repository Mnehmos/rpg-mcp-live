...
| `open5e:condition:5e-2014:srd-2014:blinded` | deferred | Condition effect compilation remains outside S3. |
| `open5e:condition:5e-2014:srd-2014:charmed` | deferred | Condition effect compilation remains outside S3. |
| `open5e:condition:5e-2014:srd-2014:deafened` | deferred | Condition effect compilation remains outside S3. |
| `open5e:condition:5e-2014:srd-2014:exhaustion` | deferred | Condition effect compilation remains outside S3. |
| `open5e:condition:5e-2014:srd-2014:frightened` | deferred | Condition effect compilation remains outside S3. |
| `open5e:condition:5e-2014:srd-2014:grappled` | deferred | Condition effect compilation remains outside S3. |
| `open5e:condition:5e-2014:srd-2014:incapacitated` | deferred | Condition effect compilation remains outside S3. |
| `open5e:condition:5e-2014:srd-2014:invisible` | deferred | Condition effect compilation remains outside S3. |
| `open5e:condition:5e-2014:srd-2014:paralyzed` | deferred | Condition effect compilation remains outside S3. |
| `open5e:condition:5e-2014:srd-2014:petrified` | deferred | Condition effect compilation remains outside S3. |
| `open5e:condition:5e-2014:srd-2014:poisoned` | deferred | Condition effect compilation remains outside S3. |
| `open5e:condition:5e-2014:srd-2014:prone` | deferred | Condition effect compilation remains outside S3. |
| `open5e:condition:5e-2014:srd-2014:restrained` | deferred | Condition effect compilation remains outside S3. |
| `open5e:condition:5e-2014:srd-2014:stunned` | deferred | Condition effect compilation remains outside S3. |
| `open5e:condition:5e-2014:srd-2014:unconscious` | deferred | Condition effect compilation remains outside S3. |
