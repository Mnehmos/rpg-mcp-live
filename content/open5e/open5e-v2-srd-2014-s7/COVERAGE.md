...
| creatures | srd-2014 | 5e-2014 | 0 | 45 | 280 |
...
| `open5e:condition:5e-2014:srd-2014:blinded` | deferred | Condition effect compilation remains outside S7. |
| `open5e:condition:5e-2014:srd-2014:charmed` | deferred | Condition effect compilation remains outside S7. |
| `open5e:condition:5e-2014:srd-2014:deafened` | deferred | Condition effect compilation remains outside S7. |
| `open5e:condition:5e-2014:srd-2014:exhaustion` | deferred | Condition effect compilation remains outside S7. |
| `open5e:condition:5e-2014:srd-2014:frightened` | deferred | Condition effect compilation remains outside S7. |
| `open5e:condition:5e-2014:srd-2014:grappled` | deferred | Condition effect compilation remains outside S7. |
| `open5e:condition:5e-2014:srd-2014:incapacitated` | deferred | Condition effect compilation remains outside S7. |
| `open5e:condition:5e-2014:srd-2014:invisible` | deferred | Condition effect compilation remains outside S7. |
| `open5e:condition:5e-2014:srd-2014:paralyzed` | deferred | Condition effect compilation remains outside S7. |
| `open5e:condition:5e-2014:srd-2014:petrified` | deferred | Condition effect compilation remains outside S7. |
| `open5e:condition:5e-2014:srd-2014:poisoned` | deferred | Condition effect compilation remains outside S7. |
| `open5e:condition:5e-2014:srd-2014:prone` | deferred | Condition effect compilation remains outside S7. |
| `open5e:condition:5e-2014:srd-2014:restrained` | deferred | Condition effect compilation remains outside S7. |
| `open5e:condition:5e-2014:srd-2014:stunned` | deferred | Condition effect compilation remains outside S7. |
| `open5e:condition:5e-2014:srd-2014:unconscious` | deferred | Condition effect compilation remains outside S7. |
...
| `effects/creature-actions` | compiled | 291 source-retaining action programs compiled; 84 have a complete execution mode and 207 remain non-executable typed fragments. |
| `effects/spell-areas` | compiled | 49 spells have typed area-shape programs corroborated by normalized Open5e geometry. |
