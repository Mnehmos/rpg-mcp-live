    ...
    const messages: ChatMessage[] = [
      {
        ...
        content: [
          ...
          "For social contests use social_check. For a new quest use quest_create, for progress use quest_update, for a proactive story turn use campaign_beat, and for a rule-of-cool stunt use improvise with a typed mechanical effect when one exists.",
